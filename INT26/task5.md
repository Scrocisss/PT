# В файле log.evtx приведены события из журнала аудита на хосте, где злоумышленник выполнил некоторые действия в ходе развития атаки. Внимательно изучите события и ответьте на вопросы:
